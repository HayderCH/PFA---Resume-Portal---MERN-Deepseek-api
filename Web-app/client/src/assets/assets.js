...
export const analyticsData = [
  { field: "Machine Learning", count: 120, category: "AI" },
  { field: "Web Development", count: 200, category: "Development" },
  { field: "Mobile Development", count: 150, category: "Development" },
  { field: "Data Science", count: 90, category: "AI" },
  { field: "Cybersecurity", count: 70, category: "Security" },
  { field: "UI/UX Design", count: 110, category: "Design" },
];

// Total users over time (weekly evolution)
export const userEvolutionData = [
  { week: "Week 1", users: 50 },
  { week: "Week 2", users: 75 },
  { week: "Week 3", users: 100 },
  { week: "Week 4", users: 150 },
  { week: "Week 5", users: 200 },
];

// Average resumes per user
export const averageResumesPerUser = 3.5;
